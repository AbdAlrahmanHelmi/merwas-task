      ...
      <footer className="container-me ">
        <div className="sm-visible">
          ...
          <div className="d-flex">
            <div className="footer-input__form d-flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                fill="currentColor"
                class="footer-envelope"
                viewBox="0 0 16 16"
              >
            ...
            <div>
              <button className="btn btn-primary footer-btn">Subscribe</button>
            </div>
          </div>
          <hr />
        </div>
        <div className="grid-footer ">
          <div className="text-start">
            ...
            <button className="btn btn-primary footer-btn">
              ...
              <span className="btn-text">Download our App</span>
            </button>
          </div>
          ...
          <div>
            ...
            <p className="footer-link">Terms & Returns</p>
          ...
          <div>
            ...
            <p className="footer-link">My Coupons</p>
            <p className="footer-link">FAQ</p>
          </div>
          <div>
            <h4 className="main-footer_heading ">Merchants</h4>
            <p className="footer-link">Run a Deal</p>
            <p className="footer-link">Merchant Centre</p>
          </div>
